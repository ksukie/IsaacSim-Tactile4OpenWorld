...
class ISimSystem
{
  public:
    ...
    bool write_vertex_pos_pair_to_sim(span<const Vector3> previous_positions, span<const Vector3> current_positions, IndexT vertex_offset, SizeT vertex_count);
  ...
  protected:
    ...
    virtual bool             do_write_vertex_pos_pair_to_sim(span<const Vector3> previous_positions, span<const Vector3> current_positions, IndexT vertex_offset, SizeT vertex_count);
