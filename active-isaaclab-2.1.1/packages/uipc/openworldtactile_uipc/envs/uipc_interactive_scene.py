...
from openworldtactile_uipc.objects import UipcObject, UipcObjectCfg
...
class UipcInteractiveScene:
    ...
    * For tasks that require having separate assets in the environments, ``replicate_physics`` would have to
    ...
    def update(self, dt: float) -> None:
        ...
        # -- uipc objects
        for uipc_object in self._uipc_objects.values():
            uipc_object.update(dt)
