...
from isaaclab_contrib.sensors.openworldtactile_sensor import OWT_ASSET_ROOT, VisuoTactileSensor, VisuoTactileSensorCfg
from isaaclab_contrib.sensors.openworldtactile_sensor.visuotactile_sensor_cfg import GelSightRenderCfg
...
def setup(sensor_type: str = "cube"):
    ...
    # gelsightr15 filter
    usd_file_path = f"{OWT_ASSET_ROOT}/gelsight_r15_finger/gelsight_r15_finger.usd"
