...
parser = argparse.ArgumentParser(
    description=(
        "V5 new stage 3g: PhysX grasp plus baseline-cleaned UIPC Fz with UIPC_Pad mounted as a stable "
        ...
        "hides UIPC compute visuals and the floating pad camera surface, keeps the pad visual back mesh "
        "as the viewport membrane, and aligns the UIPC_Pad "
...
parser.add_argument("--output_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_3g_keep_back_visual_membrane")
parser.add_argument("--workspace_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_3g_workspace")
...
parser.add_argument("--hide_pad_camera_surface", dest="hide_pad_camera_surface", action="store_true", default=True)
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "script_version": "v5_new_3g_keep_back_visual_membrane",
    ...
    try:
        ...
        metadata = {
            ...
            "purpose": (
                ...
                "keep_back_visual_membrane_hide_camera_surface_and_pad_center_freeze"
            ),
