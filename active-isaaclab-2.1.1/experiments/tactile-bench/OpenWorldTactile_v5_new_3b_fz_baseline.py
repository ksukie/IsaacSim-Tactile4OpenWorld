...
parser = argparse.ArgumentParser(
    description=(
        "V5 new stage 3b: PhysX grasp plus baseline-cleaned UIPC Fz with UIPC_Pad mounted as a stable "
        ...
        "baseline suppression. It intentionally does not create RGB tactile output, Fx/Fy output, or a NutTool."
    )
)
parser.add_argument("--output_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_3b_uipc_fz_baseline_clean")
parser.add_argument("--workspace_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_3b_workspace")
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "script_version": "v5_new_3b_uipc_fz_baseline_clean",
    ...
    try:
        ...
        metadata = {
            "script_version": "v5_new_3b_uipc_fz_baseline_clean",
            "purpose": "mounted_pad_physx_grasp_with_uipc_fz_only_baseline_clean",
