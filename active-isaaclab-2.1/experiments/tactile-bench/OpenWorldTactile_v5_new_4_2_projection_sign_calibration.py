...
parser = argparse.ArgumentParser(
    description=(
        "V5 new stage 4_2: native UIPC contact-gradient projection sign and correlation calibration. "
        "The 3h contact_geometry penetration proxy remains the compatibility tactile output; this script "
        "only diagnoses native pad-local axis/sign candidates, phase correlation, grid alignment, and "
        "signed cancellation for the 4_1 native projection side-channel."
    )
)
parser.add_argument(
    "--output_dir",
    type=str,
    default="/tmp/openworldtactile_uipc_v5_new_4_2_native_projection_sign_correlation_calibration_check",
)
parser.add_argument("--workspace_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_4_2_workspace")
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "script_version": "v5_new_4_2_native_projection_sign_correlation_calibration",
                "native_uipc_contact_force_probe_enabled": bool(args_cli.native_uipc_force_probe),
                "native_force_projection_calibration_enabled": True,
                "native_projection_sign_correlation_calibration_enabled": True,
                "native_uipc_contact_force_used": False,
                "native_uipc_contact_force_replaces_proxy": False,
    ...
    try:
        ...
        metadata = {
            "script_version": "v5_new_4_2_native_projection_sign_correlation_calibration",
            "purpose": (
                "diagnose_native_projection_sign_scale_correlation_and_grid_alignment_without_replacing_3h_proxy_output"
            ),
            "pad_layer_direction_contract": PAD_LAYER_DIRECTION_CONTRACT,
            "uipc_contact_face_source": PAD_CONTACT_FACE_SOURCE,
            "visual_layer_swap_enabled": bool(args_cli.visual_layer_swap),
