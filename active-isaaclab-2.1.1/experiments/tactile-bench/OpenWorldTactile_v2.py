...
parser = argparse.ArgumentParser(
    description=(
        "V2 fixed soft-membrane tactile force validation bench. Force estimation "
        "is provided by experiments/tactile-bench/api/openworldtactile_uipc_force.py."
    )
)
parser.add_argument(
    "--shape",
...
parser.add_argument("--output_dir", type=str, default="/tmp/openworldtactile_newbench_v2_validation")
...
parser.add_argument(
    ...
    default=False,
    action="store_true",
    help="Reserved for Isaac/UIPC debug visualization. V2 does not create a separate texture skin.",
)
...
def main() -> None:
    ...
    print(
        "[INFO] OpenWorldTactileBench V2 started: "
    ...
    if not should_save:
        print(
            "[INFO] OpenWorldTactileBench V2 complete: "
