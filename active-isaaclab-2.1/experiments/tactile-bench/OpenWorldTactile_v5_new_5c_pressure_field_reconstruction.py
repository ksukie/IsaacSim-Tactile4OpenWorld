...
EPS = 1.0e-12
SCRIPT_VERSION = "v5_new_5c_pressure_field_reconstruction"
EXPECTED_CONDA_ENV = "isaaclab211"
OFFICIAL_TACTILE_SOURCE = "contact_geometry_penetration_proxy"
OFFICIAL_FORCE_SOURCE = "uipc_contact_geometry_penetration_proxy_fz_only_baseline_corrected"
...
parser = argparse.ArgumentParser(
    description=(
        "V5 new stage 5c: official proxy tactile output with pressure field reconstruction. "
        "This keeps the validated contact_geometry penetration proxy Fz source unchanged, stores "
        "mesh front-face vertex data as the formal numeric source, and reconstructs a continuous "
        "force-conserving proxy pressure field for grid arrays and pressure videos."
    )
)
parser.add_argument("--output_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_5c_pressure_field_reconstruction")
parser.add_argument("--workspace_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_5c_workspace")
...
def main() -> None:
        ...
        json.dumps(
            {
                ...
                "fx_fy_contract": "zero-valued proxy placeholders; official force source is Fz only",
    ...
    try:
        ...
        shear_video_diagnostics: dict[str, object] = {
            ...
            "shear_source": "local_fxyz_vertices_xy_channels",
        ...
        if uipc_frame_count > 0:
            ...
            shear_video_diagnostics = {
                ...
                "current_stage_note": (
                    "Fx/Fy are passed through from local_fxyz_vertices x/y channels. If those channels are zero, "
                    "the shear grids and videos are expected to be zero/black; this is a channel-output smoke path, "
                    "not evidence of calibrated shear force."
                ),
                "not_used": [
        ...
        metadata = {
            ...
            "expected_conda_env": EXPECTED_CONDA_ENV,
            "runtime_conda_env": str(os.environ.get("CONDA_DEFAULT_ENV", "")),
            "version_role": "official_proxy_tactile_output_with_pressure_field_reconstruction",
            "purpose": (
                "official_proxy_tactile_output_from_validated_3h_pipeline_with_contact_geometry_"
                "penetration_proxy_fz_only_baseline_corrected_and_force_conserving_pressure_field_reconstruction"
            ),
            "official_tactile_source": OFFICIAL_TACTILE_SOURCE,
            ...
            "native_uipc_contact_force_probed": False,
            "native_uipc_contact_force_replaces_proxy": False,
            "fx_fy_contract": "local_fx/local_fy are zero-valued placeholders; official proxy source is Fz only",
            "fx_fy_zero_placeholders": True,
            "tactile_data_semantics": {
                "raw_vertex_layer": {
                    ...
                    "source": "contact_geometry_penetration_proxy_fz_only_baseline_corrected",
                },
                "sparse_grid_layer": {
                    "files": [
                        "local_fxyz_grid_sparse.npy",
                ...
                "shear_proxy_visualization_layer": {
                    ...
                    "role": "output_chain_for_local_fxyz_xy_channels_not_formal_force_source",
                    "source": "local_fxyz_vertices_xy_channels",
