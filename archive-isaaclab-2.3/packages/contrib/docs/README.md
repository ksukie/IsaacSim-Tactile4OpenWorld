...
See the [OpenWorldTactile Tactile Sensor](#openworldtactile-tactile-sensor-detailed) section below for detailed documentation.
...
│   └── openworldtactile_sensor/       # OpenWorldTactile tactile sensor implementation
...
## OpenWorldTactile Tactile Sensor (Detailed)

This section provides detailed documentation for the OpenWorldTactile tactile sensor contribution, which enables GPU-based simulation of vision-based tactile sensors in Isaac Lab. The implementation is based on the the upstream tactile-simulation framework from [Akinola et al., 2025](https://arxiv.org/abs/2408.06506) and uses the Taxim model from [Si et al., 2022](https://arxiv.org/abs/2109.04027) for rendering tactile images.

<details>

### Features

The OpenWorldTactile tactile sensor system includes:
...
The OpenWorldTactile sensor supports two complementary sensing modalities:
...
A complete demonstration of OpenWorldTactile tactile sensor is available:

```bash
# Run OpenWorldTactile tactile sensor demo with RGB and force field sensing
./isaaclab.sh -p scripts/demos/sensors/openworldtactile_sensor.py \
    --use_tactile_rgb \
    --use_tactile_ff \
    --num_envs 16 \
