...
parser = argparse.ArgumentParser(
    description=(
        "V5 new stage 3h: PhysX grasp plus baseline-cleaned UIPC Fz with UIPC_Pad mounted as a stable "
        "link8 child asset. This verifies mount stability, smooth gripper motion, "
        ...
        "The UIPC contact/front face is fixed to the sim mesh local +X outer face. "
        "It intentionally does not create RGB tactile output, Fx/Fy output, or a NutTool."
    )
)
parser.add_argument("--output_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_3h_swap_visual_membrane_layers")
parser.add_argument("--workspace_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_3h_workspace")
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "script_version": "v5_new_3h_swap_visual_membrane_layers",
    ...
    try:
        ...
        metadata = {
            ...
            "purpose": (
                ...
                "fixed_sim_mesh_outer_x_contact_face_hide_camera_surface_and_pad_center_freeze"
            ),
            "pad_layer_direction_contract": PAD_LAYER_DIRECTION_CONTRACT,
            "uipc_contact_face_source": PAD_CONTACT_FACE_SOURCE,
            "visual_layer_swap_enabled": bool(args_cli.visual_layer_swap),
