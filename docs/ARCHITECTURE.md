...
| 顶层位置 | 职责 | 是否独立运行环境 |
|---|---|---|
| [`active-isaaclab-2.1/`](../active-isaaclab-2.1/) | OpenWorldTactile、UIPC、AgileX/Piper 当前主线 | 是，依赖 Isaac Lab 2.1.1 |
| [`archive-isaaclab-2.3/`](../archive-isaaclab-2.3/) | OpenWorldTactile/GelSight 传感器、外部 SDK 边界与历史实验 | 是，依赖 Isaac Lab 2.3.2 |
| [`docs/`](./) | 架构、入口、依赖与版本导航 | 否 |
