...
parser = argparse.ArgumentParser(
    description=(
        "V5 new stage 3e: PhysX grasp plus baseline-cleaned UIPC Fz with UIPC_Pad mounted as a stable "
        ...
        "hides UIPC CylinderTool visualization, and aligns the UIPC_Pad membrane center in pad-local "
        "plane axes with a frozen correction after lower-to-grasp. "
        "It intentionally does not create RGB tactile output, Fx/Fy output, or a NutTool."
    )
)
parser.add_argument("--output_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_3e_visual_clean_pad_center_freeze")
parser.add_argument("--workspace_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_3e_workspace")
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "script_version": "v5_new_3e_visual_clean_pad_center_freeze",
    ...
    hidden_membrane_count, hidden_tool_count = _rehide_uipc_compute_visuals(stage, membrane_root)
    ...
    for warmup_step in range(max(0, int(args_cli.uipc_warmup_steps))):
        ...
        if render:
            ...
            uipc_sim.update_render_meshes()
            _rehide_uipc_compute_visuals(stage, membrane_root)
    ...
    try:
        ...
        metadata = {
            ...
            "purpose": (
                ...
                "visual_clean_and_pad_center_freeze"
            ),
