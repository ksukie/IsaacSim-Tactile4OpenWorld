...
from openworldtactile.simulation_approaches.gpu_taxim import TaximSimulatorCfg
...
class BallRollingTactileRGBUipcCfg(DirectRLEnvCfg):
    ...
    gsmini = GelSightMiniCfg(
        ...
        optical_sim_cfg=TaximSimulatorCfg(
            calib_folder_path=f"{OWT_ASSETS_DATA_DIR}/Sensors/GelSight_Mini/calibs/640x480",
