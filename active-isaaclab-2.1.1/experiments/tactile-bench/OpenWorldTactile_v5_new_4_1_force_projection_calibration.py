...
parser = argparse.ArgumentParser(
    description=(
        "V5 new stage 4_1: native UIPC contact-gradient projection calibration on top of the validated "
        "3h link8 UIPC_Pad pipeline and v4 probe. The 3h contact_geometry penetration proxy remains "
        "the compatibility tactile output; this script projects native UIPC contact-gradient vectors "
        "into pad-local tactile Fx/Fy/Fz side-channel signals for calibration diagnostics."
    )
)
parser.add_argument("--output_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_4_1_native_force_projection_calibration")
parser.add_argument("--workspace_dir", type=str, default="/tmp/openworldtactile_uipc_v5_new_4_1_workspace")
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                "script_version": "v5_new_4_1_native_force_projection_calibration",
    ...
    try:
        ...
        metadata = {
            "script_version": "v5_new_4_1_native_force_projection_calibration",
            "purpose": (
                "project_native_uipc_contact_gradient_to_pad_local_fx_fy_fz_without_replacing_3h_proxy_output"
            ),
            "pad_layer_direction_contract": PAD_LAYER_DIRECTION_CONTRACT,
            "uipc_contact_face_source": PAD_CONTACT_FACE_SOURCE,
            "visual_layer_swap_enabled": bool(args_cli.visual_layer_swap),
